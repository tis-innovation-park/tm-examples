...
public class SeleniumTests {
	...
	public void verifyLinkAbendschulen() {
		loadServicesPage();
		clickAndLoadAbendschulen();
		WebElement element = ((FindsByLinkText) driver)
				.findElementByLinkText("Abendschule für Erwachsene - Mittelschule (Italienisches Schulamt)");
	...
	public void verifyTextAbendSchulen() {
		...
		Assert.assertEquals(
				"Nella nostra provincia l'Istituto Comprensivo Bolzano III di via Napoli 1 - Bolzano è il punto di riferimento per questo tipo di servizio.",
				driver.findElement(By.xpath("//div[@id='main']/p[3]"))
						.getText());
	}
...
//		clickAndLoadAbendschulen();
//		clickAndLoadAbendschulenErwachsen();
//		Assert.assertEquals("is.organici@scuola.alto-adige.it", driver
//				.findElement(By.linkText("is.organici@scuola.alto-adige.it"))
//				.getText());
//	}
//
//	@Test
...
//		clickAndLoadAbendschulen();
//		clickAndLoadAbendschulenErwachsen();
//		Assert.assertEquals("is.organici@pec.prov.bz.it",
//				driver.findElement(By.linkText("is.organici@pec.prov.bz.it"))
//						.getText());
//
//	}
//
...
//		clickAndLoadAbendschulenErwachsen();
//		Assert.assertEquals(
//				"http://www.provinz.bz.it/italienisches-schulamt/verwaltung/83.asp",
//				driver.findElement(
//						By.linkText("http://www.provinz.bz.it/italienisches-schulamt/verwaltung/83.asp"))
//						.getText());
//
//	}
//
//	// Start testing Abendoberschule
//	// http://www.provinz.bz.it/de/dienste/dienste-az.asp?bnsvaz_svid=1005822
//
//	@Test
...
//		clickAndLoadAbendoberschule();
//		Assert.assertEquals(
//				"Die Abendkurse erstrecken sich über drei Jahre. Das erste Kursjahr bereitet auf die Eignungsprüfung der ersten und zweiten Klasse, das zweite Kursjahr auf die Eignungsprüfung der dritten und vierten Klasse und das dritte Kursjahr die Privatistinnen und Privatisten auf die Matura vor.",
//				driver.findElement(By.xpath("//div[@id='main']/p[]")).getText());
//	}
//
//	// Verify all links on
//	// http://www.provinz.bz.it/de/dienste/dienste-az.asp?bnsvaz_svid=1005822
...
//		clickAndLoadAbendoberschule();
//		driver.findElement(
//				By.linkText("http://www.provinz.bz.it/schulamt/verwaltung/111.asp?intOrga_id=8"))
//				.click();
...
//		clickAndLoadAbendoberschule();
//		Assert.assertEquals(
//				"sa.schulverwaltung@schule.suedtirol.it",
//				driver.findElement(
//						By.linkText("sa.schulverwaltung@schule.suedtirol.it"))
//						.getText());
//	}
//
//	@Test
...
//				driver.findElement(
//						By.linkText("schulverwaltung.ammscolastica@pec.prov.bz.it"))
//						.getText());
//
//	}
//
...
//		clickAndLoadAbendoberschule();
//		Assert.assertEquals(
//				"http://www.provinz.bz.it/schulamt/verwaltung/111.asp?intOrga_id=8",
//				driver.findElement(
//						By.xpath("//a[contains(.,'http://www.provinz.bz.it/schulamt/verwaltung/111.asp?intOrga_id=8')]"))
//						.getText());
//
//	}
//
//	// Start testing Schulkalender (Deutsches Schulamt)
//	// http://www.provinz.bz.it/de/dienste/dienste-az.asp?bnsvaz_svid=1029144
//
//	@Test
...
//		Assert.assertEquals(actualTitle, expectedTitle);
//		Assert.assertEquals(
//				"An den Südtiroler Grund-, Mittel- und Oberschulen mit deutscher Unterrichtssprache findet der Unterricht an fünf Tagen pro Woche statt. Einige wenige Oberschulen haben die Sechs-Tage-Woche. Eine Schule kann die Unterrichtsstunden auch auf sechs Wochentage verteilen, wenn Sie gemäß Landesgesetz Nr. 13 vom 13. Juli 2012 die Ermächtigung dafür erhält.",
//				driver.findElement(By.xpath("//div[@id='main']/p[1]"))
//						.getText());
//
//	}
//
...
//		clickAndLoadSchulkalenderDE();
//		Assert.assertEquals(
//				"deutsches.schulamt@schule.suedtirol.it",
//				driver.findElement(
//						By.linkText("deutsches.schulamt@schule.suedtirol.it"))
//						.getText());
//	}
//
//	@Test
...
//		clickAndLoadSchulkalenderDE();
//		Assert.assertEquals(
//				"schulamt.intendenzascolastica@pec.prov.bz.it",
//				driver.findElement(
//						By.linkText("schulamt.intendenzascolastica@pec.prov.bz.it"))
//						.getText());
//
//	}
//
...
//				driver.findElement(
//						By.xpath("//a[contains(.,'http://www.provinz.bz.it/schulamt/')]"))
//						.getText());
//
//	}
//
//	// Start testing Schulkalender (Italienisches Schulamt)
//	// http://www.provinz.bz.it/de/dienste/dienste-az.asp?bnsvaz_svid=1002760
//
//	@Test
...
//		Assert.assertEquals(actualTitle, expectedTitle);
//		Assert.assertEquals(
//				"Dieser Dienst wird vom Italienischen Schulamt angeboten. Die nachfolgenden Informationen liegen nur in italienischer Sprache vor.",
//				driver.findElement(By.xpath("//div[@id='main']/p[2]"))
//						.getText());
//
//	}
//
...
//		Assert.assertEquals(
//				"Beschluss vom 23. Januar 2012, Nr. 75 (abgeändert mit Beschluss Nr. 210 vom 13.02.2012) - Schulkalender ›",
//				driver.findElement(
//						By.xpath(".//*[@id='servicelink']/table/tbody/tr/td[2]/ul/li/a"))
//						.getText());
//
//	}
//
...
//		clickAndLoadSchulkalenderIT();
//		driver.findElement(
//				By.linkText("Beschluss vom 23. Januar 2012, Nr. 75 (abgeändert mit Beschluss Nr. 210 vom 13.02.2012)"))
//				.click();
//		String expectedTitle = "Beschluss vom 23. Januar 2012, Nr. 75 (abgeändert mit Beschluss Nr. 210 vom 13.02.2012) - Kindergarten- und Schulkalender | Formulare nach Kategorien | Südtiroler Bürgernetz";
//		String actualTitle = driver.getTitle();
//		Assert.assertEquals(actualTitle, expectedTitle);
//		Assert.assertEquals(
//				"Beschluss vom 23. Januar 2012, Nr. 75 (abgeändert mit Beschluss Nr. 210 vom 13.02.2012) - Kindergarten- und Schulkalender",
...
//		clickAndLoadAbendschulen();
//		clickAndLoadSchulkalenderIT();
//		Assert.assertEquals("is.ord-scol@scuola.alto-adige.it", driver
//				.findElement(By.linkText("is.ord-scol@scuola.alto-adige.it"))
//				.getText());
//	}
//
//	@Test
...
//		clickAndLoadAbendschulen();
//		clickAndLoadSchulkalenderIT();
//		Assert.assertEquals("is.ord-scol@pec.prov.bz.it",
//				driver.findElement(By.linkText("is.ord-scol@pec.prov.bz.it"))
//						.getText());
//
//	}
//
...
//				"http://www.provinz.bz.it/italienisches-schulamt/verwaltung/83.asp",
//				driver.findElement(
//						By.xpath("//a[contains(.,'http://www.provinz.bz.it/italienisches-schulamt/')]"))
//						.getText());
//
//	}
	...
	// TODO
	/*
	 * Find a smart way to check if download link provides the correct status
	 * code.
	 */
	...
	private void clickAndLoadAbendschulenErwachsen() {
		driver.findElement(
				By.linkText("Abendschule für Erwachsene - Mittelschule (Italienisches Schulamt)"))
				.click();
	}
	
//	private void clickAndLoadAbendoberschule() {
//		driver.findElement(By.linkText("Deutschsprachige Abendoberschule"))
//				.click();
//	}
//
//	private void clickAndLoadSchulkalenderDE() {
//		driver.findElement(By.linkText("Schulkalender (Deutsches Schulamt)"))
//				.click();
//	}
//
//	private void clickAndLoadSchulkalenderIT() {
//		driver.findElement(
//				By.linkText("Schulkalender (Italienisches Schulamt)")).click();
//	}
}
